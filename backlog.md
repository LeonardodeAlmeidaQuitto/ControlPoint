...
- [x] Implementar tela de Login e autenticação no Painel RH
- [x] Implementar funcionalidade "Criar Cartão" com formulário e gerador de QR Code do crachá
- [x] Implementar funcionalidade "Ver Funcionários" listando histórico e crachás
